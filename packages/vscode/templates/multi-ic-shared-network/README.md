...
Open `shared.stationeerssim.json` and debug either IC to observe coordinated
scheduling. Run `ic10 test shared.stationeerstest.json`. Tests cover the default,
