...
const hello = { apiVersion: "1.0", bridgeVersion: "0.1.0", gameVersion: "fixture", instanceId: "i", role: "singlePlayer", world: { loaded: true, epoch: "epoch-1", revision: "1" }, capabilities: { scopeDiscovery: true, ic10SourceRead: true, ic10SourceWrite: false, multiplayerRelay: false, eventStream: true } };
