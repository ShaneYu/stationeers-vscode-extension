...
The one-door airlock template is a compact starting point for learning the
simulation model. It demonstrates device aliases, state transitions, sensor
...
For a larger controller, compare it with the two-door airlock and filtration
