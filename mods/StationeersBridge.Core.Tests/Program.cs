...
Require(scopes.GetProperty("chips")[0].GetProperty("identitySource").GetString() == "chip", "chip identity source");
...
Console.WriteLine("Bridge contract fixtures and write slice: 13 assertions passed.");
