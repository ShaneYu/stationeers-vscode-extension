...
Open `airlock.stationeerssim.json`, select `controller`, and choose **Debug**. Run
`ic10 test airlock.stationeerstest.json`. Atmospheric flow is intentionally driven by
